    ...
    <div class="row">
        <div class="col-xl-12 col-md-12 col-12  p-4">
            ...
            <div class="col-xl-12 col-md-12 col-12  p-4">
                        ...
                        <a class="btn btn-primary" href="{{route('add.account.create')}}">Thêm</a>
                       ...
                       @foreach ($admin as $key => $item)
                        <tr class="mb-3">
                            ...
                            <td class="text-center">
                                <a href="{{route('add.account.update',['id' =>$item->id])}}" class="btn btn-secondary ">Sửa</a>

                            </td>
                            <td class="text-center">
                                <a href="{{route('add.account.delete',['id' => $item->id])}}" class="btn btn-danger ">Xoá</a>
